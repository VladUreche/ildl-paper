...
\begin{table*}[t!]
  ...
  \end{tabularx}
  \vspace{-1.9mm}
  \caption{Least Squares Method and Sensor Readings benchmark results.}
  \label{table:lslr}
%   \vspace{-1em }
\end{table*}
...
This transformation alone produced a 3x speedup for an input of 5 million points and made the |adrt| transformation perform better than the dedicated collection optimization tool |scalablitz| \cite{scalablitz, scalablitz-paper}, which produced a modest 1.7x speedup.
