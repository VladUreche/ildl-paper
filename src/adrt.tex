...
transformation that may be incorrect for code outside the transformed scope.
...
\item the ability for separately transformed scopes to communicate via the representation type, a property we call composability and that works across separate source files and compilation runs (\S\ref{sec:ildl:compose});
