...
Type-checking the program makes into an explicit call the implicit conversion that introduces the |*| operator:
...
This allows the call to the |*| operator to be transformed into a bypass call, avoiding heap object creation, and thus significantly improving the performance and heap footprint. %Bypass methods are worth a second, more detailed, look.
