...
The main insight in this section is that persisting the description object within each value's annotated type allows efficient scope composition across separate compilation runs.%and eliminates the need for inefficient bridge methods.
