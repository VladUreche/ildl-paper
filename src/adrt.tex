...
We augmented the LDL extension method rewiring mechanism to also work for methods that are added through implicit conversions. This allows the high-level types in |adrt| scopes to have optimized implicit methods, such as the |*| and |%| operator for pairs of integers, that are implemented directly on their long integer encoding.
%
%
%
%
