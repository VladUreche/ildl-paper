...
second, it allows the transformation to take place for limited scopes,
...
In this case, the \bridge{} phase generates two bridge methods, one for each existing signature of the method |identity|:
