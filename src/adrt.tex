...
This section presents the interaction between the ADR transformation and object-oriented inheritance, generics and implicit conversions, explaining the additional steps that are taken to ensure correct program transformation. %and  the limitations of the approach.
...
\vspace{0.3em}
\noindent
\textem{Offering an alternative transformation mechanism}. Despite the apparent similarity, implicit conversions are not powerful enough
% do not offer strong enough guarantees
