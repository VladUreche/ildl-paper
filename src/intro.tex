...
transformation can be automated and what parts need domain-specific
...
the optimized representation. Thus, our approach adheres to
the principle of separating the reusable, general and provably
correct mechanism from the programmer-driven policy, which may
contain errors \cite{lampson-mechanism-policy}.
