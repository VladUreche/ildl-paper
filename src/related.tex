...
programming need. Techniques for removing abstraction barriers have appeared
...
\iv{They're very cool nevertheless.}
...
and the TIL compiler \cite{tarditi-til,harper-intensional-type-analysis}.
...
lightweight modular staging, can both optimize and even re-target parts of a
...
create serialization code that can efficiently convert an object to a wide
range of formats.
