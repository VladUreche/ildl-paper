...
How does the compiler know what encoding/decoding procedures to use to convert the pairs of integers to the long integer representation? Even worse, what if the code is compiled separately, in a different compilation unit (\S\ref{sec:ildl:separate-compilation})?
