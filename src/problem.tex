...
\item[(2)] Transforming the source code to use the improved representation, based on the description object: This is the repetitive, tedious and error-prone work, which we completely automate away.
\end{compactitem}
\vspace{0.35em}
