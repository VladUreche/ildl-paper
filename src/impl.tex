...
%
% Most of the description focused on how the ADR transformation extends LDL and how it transforms the code. To allow other compiler implementers to



%  - ability to use the type checker at any phase in the compilation pipeline
%  - ability to change the symbol signature from one phase to the next
%  - ability to see a symbol's signature at any phase
%  - support for annotations
%  - support for external annotation checkers
%  - support for tree attachments
%  - typechecker support for expected types (In Scala, this is part of the local type inference)