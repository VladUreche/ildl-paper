...
% Two implementations in Scala, as a compiler plugins, starting from the LDL compiler plugins already available on the net. The rest will describe the important changes
