...
% making it a good starting point for other data representation transformations. % This chapter will present the LDL mechanism in detail.
...
%This is why the \coerce{} phase needs to be optimal.
